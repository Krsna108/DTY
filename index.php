...
<html lang="en">
  ...
  <nav role="navigation" class="navbar navbar-custom navbar-fixed-top">
          ...
          <div class="container-fluid">
              ...
              <div class="navbar-collapse collapse" id="navbarCollapse">
                  ...
                  <ul class="nav navbar-nav navbar-right">
                    <li><a href="#loginModal" data-toggle="modal">CONSOLE</a></li>
                  </ul>
      ...
      <div class="jumbotron" id="myContainer">
          <h1>Welcome to Diaspora To You</h1>
          <p>The Platform To Connect With Your Past Preserving Your Future!</p>
          <p>Explore the History of World Migration</p>
<!--          <button type="button" class="btn btn-lg green signup" data-target="#signupModal" data-toggle="modal">Console Login</button>-->
      </div>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 id="myModalLabel">
                    Join us today!  and Dive Into The Journey of World Migration! 
                  </h4>
              </div>
              <div class="modal-body">
